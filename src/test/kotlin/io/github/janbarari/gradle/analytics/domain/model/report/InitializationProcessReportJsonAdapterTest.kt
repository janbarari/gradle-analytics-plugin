...
class InitializationProcessReportJsonAdapterTest {

    lateinit var moshi: Moshi
    lateinit var adapter: InitializationProcessReportJsonAdapter

    @BeforeAll
    fun setup() {
        moshi = Moshi.Builder().build()
        adapter = InitializationProcessReportJsonAdapter(moshi)
    }
...
//        }
    ...
    fun `Check toJson() return valid Json with valid data model`() {
        val validModel = InitializationProcessReport(
