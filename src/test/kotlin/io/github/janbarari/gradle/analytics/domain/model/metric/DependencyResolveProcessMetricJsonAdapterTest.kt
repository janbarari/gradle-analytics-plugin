...
class DependencyResolveProcessMetricJsonAdapterTest {

    lateinit var moshi: Moshi
    lateinit var adapter: DependencyResolveProcessMetricJsonAdapter

    @BeforeAll
    fun setup() {
        moshi = Moshi.Builder().build()
        adapter = DependencyResolveProcessMetricJsonAdapter(moshi)
    }
