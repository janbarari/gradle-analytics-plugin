...
class ExecutionProcessReportJsonAdapterTest {

    lateinit var moshi: Moshi
    lateinit var adapter: ExecutionProcessReportJsonAdapter

    @BeforeAll
    fun setup() {
        moshi = Moshi.Builder().build()
        adapter = ExecutionProcessReportJsonAdapter(moshi)
    }
...
//        }
    ...
    fun `Check toJson() return valid Json with valid data model`() {
        val validModel = ExecutionProcessReport(
