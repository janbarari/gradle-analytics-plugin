...
class OverallBuildProcessReportJsonAdapterTest {

    lateinit var moshi: Moshi
    lateinit var adapter: OverallBuildProcessReportJsonAdapter

    @BeforeAll
    fun setup() {
        moshi = Moshi.Builder().build()
        adapter = OverallBuildProcessReportJsonAdapter(moshi)
    }
